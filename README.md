...
git branch -M main
git remote add origin https://github.com/johnsmccain/TheBuidl-c4.git
git push -u origin main 

git pull origin main

git config --global user.email "johnsdanlami@gmail.com"
git config --global user.name "johnsmccain"
